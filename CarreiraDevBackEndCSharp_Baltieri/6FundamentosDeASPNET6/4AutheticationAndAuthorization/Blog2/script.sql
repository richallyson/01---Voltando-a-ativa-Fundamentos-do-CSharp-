...
CREATE TABLE [Post] (
    ...
    [Body] TEXT NOT NULL,
    [Slug] VARCHAR(80) NOT NULL,
    [CreateDate] SMALLDATETIME NOT NULL DEFAULT '2022-08-15T15:56:19.4164566Z',
...
CREATE TABLE [UserRole] (
    ...
    CONSTRAINT [FK_UserRole_RoleId] FOREIGN KEY ([RoleId]) REFERENCES [User] ([Id]) ON DELETE CASCADE,
...
VALUES (N'20220815155619_InitialCreation', N'6.0.8');
GO
