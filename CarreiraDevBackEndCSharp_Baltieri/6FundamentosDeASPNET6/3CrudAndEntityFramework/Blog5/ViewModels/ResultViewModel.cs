namespace Blog.ViewModels
{
    ...
    public class ResultViewModel <T>
    {
        ...
        // Algo novo que vale a pena ser explicado, no caso, esse new() ao final da propriedade
        // Lembra em outras aulas quando a gente ao criar uma lista tinha que iniciar ela dentro do construtor?
        // Isso aqui faz a mesma coisa sem que a gente precise fazer isso direto no construtor
        // O Csharp 10 já infere essa lista pra gente direto do atributo usando esse new. E ele já entende que isso é uma lista de strings
